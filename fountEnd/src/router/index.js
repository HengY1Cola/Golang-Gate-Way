  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '添加用户',
        meta: { title: '添加用户', icon: 'user', affix: false },
        hidden: true
      },
      {
        path: 'appEditUser/:id(\\d+)',
        component: () => import('@/views/app/app'),
        name: '修改用户',
        meta: { title: '修改用户', icon: 'user', affix: false },
        hidden: true
      },
      {
        path: 'appStat/:id(\\d+)',
